...
멘토링 팀은 6개월간 멘토링을 진행하고, 이후 프로젝트 팀으로 합류합니다.  

## 활동
아롬 활동은 프로젝트,멘토링,스터디 총 3가지로 구성됩니다.  

### 프로젝트
프로젝트는 실력에 따라 팀을 배정합니다.  
출시팀과 연습팀으로 나누어지며, 출시 팀은 앱 출시를 목표로 개발합니다.  
...
혼자 스터디를 신청한다면, 저희가 신청자를 받아서 팀을 배정해드립니다.  
미리 동아리 회원들 중에서 스터디 인원을 모아 신청할 수도 있습니다.  
스터디 최소인원은 4~5인입니다.  
스터디는 신청자에 한해 팀을 배정 해드리고, 인터넷 강의 교육 지원과 스터디 참여율에 따라 커피값을 지원해드립니다.  
